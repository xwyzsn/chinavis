...
<!--            </q-card>-->
          ...
          <div class="col-2 q-pa-sm">
            <q-card style="height: 500px">
              ...
              <q-separator/>
              <cand v-bind:is_drill="is_dirll" ref="cand" :area="getProvince(curRegion.adcode_pro)" :year="select_year" :pollution="polution_type" style="width: 100%;max-width: 500px" />
...
<!--                <div id="river" style="height: 100%;width: 100%"></div>-->
                <river :is_drill="is_dirll" ref="river" :day="select_day" :standard="select_standard==='standard_1'?standard_1:standard_2" :year="select_year" :mon="select_month" :area="getProvince(curRegion.adcode_pro)" style="width: 100%;height: 80%" />
            </q-card>
          </div>
          </dv-border-box1>
          ...
          <div class=" col-2 q-ma-sm" >
            ...
            <rose ref="rose" style="width: 100%;height: 80%" :standard="select_standard==='standard_1'?standard_1:standard_2" :year="select_year" :month="select_month" :day="select_day" :area="getProvince(curRegion.adcode_pro)" />
            </q-card>
...
export default {
  ...
  data () {
    ...
    return {
      ...
      days,
      polution_type:"PM2",
      base_url:'http://localhost:8003/CN-Reanalysis',
      scene:null,
      dv:null,
      drill:null,
      polutions:["PM2","PM10","SO2","NO2","CO","O3"],
  ...
  mounted() {
    ...
    fetch("http://localhost:8003/distrinct_map.json").then(res =>res.json()).then(d =>{
      this.distrinct=d;
    })
